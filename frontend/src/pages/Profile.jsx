...
const Profile = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className="min-h-[80vh] px-8 md:px-[200px] mt-8 flex md:flex-col-reverse z-10 flex-col-reverse md:items-start items-start">
                ...
                <br />
                <div className="md:sticky md:top-12 z-10 flex  justify-start md:justify-end items-start md:w-[30%] w-full md:items-end ">
